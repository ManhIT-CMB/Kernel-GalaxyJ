...
cd ..
./mkbootimg --base 0x00000000 --kernel zImage --ramdisk_offset 0x02000000 --tags_offset 0x01e00000 --pagesize 2048 --ramdisk ramdisk.cpio.gz --dt dt.img --cmdline 'console=null androidboot.hardware=qcom user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3' -o boot.img
